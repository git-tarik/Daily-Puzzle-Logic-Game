    ...
    return (
        <div className="flex flex-col items-center">
            <div className="text-center mb-6">
                <p className="text-lg text-gray-600 mb-1 brand-secondary-font">Fill the grid (1-4)</p>
                <p className="text-xs text-gray-400 brand-secondary-font">No duplicates in any row or column.</p>
            </div>

            <div className="grid grid-cols-4 gap-2 mb-8 bg-gray-200 p-2 rounded-xl">
                {grid.map((row, r) => (
                    row.map((val, c) => {
                        ...
                        return (
                            <div key={`${r}-${c}`} className="w-14 h-14 md:w-16 md:h-16">
                                <input
                                    ...
                                    className={`w-full h-full text-center text-2xl font-bold rounded-lg border focus:ring-2 focus:ring-indigo-500 outline-none transition-colors
                    ${fixed
            ...
            <button
                ...
                className="px-8 py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white font-bold rounded-full transition-colors"
            >
